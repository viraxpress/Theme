...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
    ...
    protected function _getHtml(
        ...
        if ($enableViraXpress && $isViraXpressTheme) {
            $defaultHtml = $this->getLayout()->createBlock(
                \Magento\Theme\Block\Html\Topmenu::class
            )->setTemplate('Magento_Theme::components/menu.phtml')
            ->setData(['children' => $children])->toHtml();
            return $defaultHtml;
        }
    ...
    private function setCurrentClass(Node $child, string $outermostClass): void
    {
        ...
        $child->setClass(empty($currentClass) ? $outermostClass : $currentClass . ' ' . $outermostClass);
    }
}
